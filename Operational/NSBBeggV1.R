###########################
# This script is set up to simulate UMD with bias introduced to model publication bias where selection
...
saveRDS(Normal.Simulation, file = "NSBBeggV1")
...
saveRDS(Normal.Sim.Results, file = "NSBBeggV1An")
