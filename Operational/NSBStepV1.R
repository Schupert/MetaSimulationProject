###########################
# This script is set up to simulate UMD with publication bias determined by a step function on p.
...
saveRDS(Normal.Simulation, file = "NSBStepV1")
...
#write.csv(Normal.Sim.Results, file = "NSBStepV1An.csv")
saveRDS(Normal.Sim.Results, file = "NSBStepV1An")
