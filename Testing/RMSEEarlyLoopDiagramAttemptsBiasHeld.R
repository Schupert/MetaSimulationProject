...
lines(pd2$RMSE_FE, col=colour2[1], type="s")    # Peto
lines(pd2$RMSE_DL, col=colour2[2], type="s")   # Trimfill
lines(pd2$RMSE_REML, col=colour2[3], type="s")      # Peters
lines(pd2$RMSE_Moreno, col=colour2[4], type="s")           # Limit meta-analysis, method 1
