...
pdf("Figure10.pdf", paper="a4r", width=18, height=15)
##
par(pty="m")
##
...
points(pd2$Coverage_FE, col=colour2[1], type="p", pch = 20)    # Peto
lines(pd2$Coverage_DL, col=colour2[2], type="p", pch = 20)   # Trimfill
lines(pd2$Coverage_IVHet, col=colour2[3], type="p", pch = 20)      # Peters
lines(pd2$Coverage_HC_DL, col=colour2[4], type="p", pch = 20)           # Limit meta-analysis, method 1
lines(pd2$Coverage_KH_DL, col=colour2[5], type="p", pch = 20)      # Limit meta-analysis, method 2
lines(pd2$Coverage_Moreno, col=colour2[6], type="p", pch = 20)     # Limit meta-analysis, method 3
lines(pd2$Coverage_Mult, col=colour2[7], type="p", pch = 20) 
