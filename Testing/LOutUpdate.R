###########################
# This script is set up to simulate log odds ratios with bias introduced to model the bias introduced by selective
# outcome reporting. Multiple correlated values are drawn for each individual within each study (approximating multiple measures)
# then multiple logORs created and the value with the lowest p selected for reporting.
#
...
# stopCluster(c1)
# 
# saveRDS(LogOR.Simulation, file = "LSBOutV1")
...
LogOR.Simulation <- readRDS(file = "LSBOutV1")
...
saveRDS(LogOR.Sim.Results, file = "LSBOutV1An")
